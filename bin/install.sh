#!/usr/bin/env bash
# https://raw.githubusercontent.com/b4b4r07/dotfiles/mini/etc/install
export PLATFORM
...
DOTFILES_GITHUB="https://github.com/KindMaple/dotfiles.git"; export DOTFILES_GITHUB
...
dotfiles_download() {
    ...
    if is_debug; then
        ...
        if is_exists "git"; then
            ...
            # curl or wget
            local tarball="https://github.com/KindMaple/dotfiles/archive/main.tar.gz"
